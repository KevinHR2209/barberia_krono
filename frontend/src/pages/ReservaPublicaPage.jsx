...
import { FiScissors, FiCheck, FiArrowLeft, FiArrowRight, FiClock, FiMapPin } from 'react-icons/fi'
...
export default function ReservaPublicaPage() {
  ...
  // Obtener ubicación actual por GPS del navegador
    ...
    navigator.geolocation.getCurrentPosition(
        async (pos) => {
          ...
          try {
            ...
            setClienteForm({ ...clienteForm, direccion: 'Ubicación GPS capturada', latitud: lat, longitud: lon })
          }
    ...
    return (
        <div className="min-h-screen bg-dark-900 flex items-center justify-center p-4">
          <div className="text-center max-w-md">
            ...
            <button onClick={() => { setConfirmado(false); setPaso(0); setSel({barbero:null,servicio:null,fecha:'',hora:''}); setClienteForm({nombre:'',apellido:'',email:'',telefono:'',direccion:'', latitud: null, longitud: null}) }}
                    ...
                    <div className="relative">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <button
                            ...
                            className="text-xs text-krono-600 hover:text-krono-700 font-medium flex items-center gap-1 transition-colors"
                        >
                          <FiMapPin />
                      ...
                      <input
                          ...
                          placeholder="Ej: Avenida Brasil, Valparaíso"
